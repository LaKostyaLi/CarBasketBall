...
public class CarController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        _colliderFrLeft.motorTorque = Input.GetAxis("Vertical") * _force * 100000000;
        _colliderFrRight.motorTorque = Input.GetAxis("Vertical") * _force*100000000;
        _colliderLeft.motorTorque = Input.GetAxis("Vertical") * _force * 100000000;
        _colliderRight.motorTorque = Input.GetAxis("Vertical") * _force * 100000000;
